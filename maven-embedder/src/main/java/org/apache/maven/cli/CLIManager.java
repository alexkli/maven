...
public class CLIManager
{
    ...
    public static final char ANALYZE = 'a';
    ...
    public CLIManager()
    {
        ...
        options.addOption( OptionBuilder.withLongOpt( "analyze" ).withDescription( "Display mojo profiling information" ).create( ANALYZE ) );
